      ...
      {showLoginPopup && currentView === 'login' && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4">
          <div 
            ...
            aria-hidden="true"
          />
          <div className="relative w-full max-w-[340px] transform overflow-hidden rounded-[16px] bg-white shadow-2xl border border-neutral-100 transition-all duration-200 flex flex-col font-sans select-none animate-in fade-in zoom-in-95">
            {/* Header */}
            <div className="relative flex items-center justify-center py-3.5 px-4 border-b border-neutral-100 select-none">
              ...
              <span className="text-[16px] font-bold text-neutral-800 tracking-tight text-center">
                Grupo de Vendas
              </span>
            </div>
            ...
            <div className="px-5 py-5 select-text">
              <p className="text-[13px] text-neutral-600 leading-relaxed text-center">
                Acompanhe as novidades e tire suas dúvidas diretamente com nossa equipe.
              </p>
            </div>

            {/* Footer */}
            <div className="px-5 pb-5 pt-1 flex flex-col justify-center items-center gap-3 w-full">
              <a 
                href="https://chat.whatsapp.com/KuvqmnwRitGIJi5PsYqt4W"
                target="_blank"
                rel="noopener noreferrer"
                className="w-full h-10 bg-[#25D366] hover:bg-[#1ebd5a] active:scale-[0.98] text-white text-[13px] font-semibold rounded-[8px] transition-all flex items-center justify-center gap-2 cursor-pointer shadow-sm shadow-[#25D366]/20"
                onClick={() => setShowLoginPopup(false)}
              >
              ...
              <button 
                onClick={() => setShowLoginPopup(false)}
                className="text-xs text-neutral-400 hover:text-neutral-600 transition-colors w-full text-center p-2"
              >
                Fechar automaticamente em {popupCountdown}s
              </button>
            </div>
          </div>
        </div>
